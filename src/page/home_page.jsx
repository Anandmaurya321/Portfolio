...
const Portfolio = () => {
  ...
  const stats = [
    { label: "LeetCode Max Rating", value: "1814", color: "text-yellow-400" },
    { label: "CodeChef Max Rating", value: "1639", color: "text-orange-400" },
    { label: "Contests Participated", value: "60+", color: "text-cyan-400" },
  ];
  ...
  const projects = [
    {
      title: "Home_Help – Service Marketplace Platform",
      description:
        "A production-grade full-stack marketplace connecting daily-wage service providers with users, featuring real-time location tracking and secure role-based access.",
      tech: [
        "React",
        "Node.js",
        "MongoDB",
      ...
      image: "https://placehold.co/600x400/020617/38bdf8?text=Home_Help"
    }
    ,
    {
      title: "AI-Powered Career Email Automation",
      description:
        "An AI-driven email workflow system that classifies and responds to internship-related emails using LLMs, reducing manual effort by 90%.",
      tech: [
        "n8n",
        "OpenAI API",
        "Gmail API",
      ...
      features: [
        "7-Stage Internship Email Classification",
        "LLM-Based Context-Aware Replies",
        "Scheduled Automation Workflows",
        "Structured Tracking via Google Sheets"
      ],
      link: "#",
      image: "https://placehold.co/600x400/020617/10b981?text=AI+Automation"
    }
  ];
  ...
  const experience = [
    {
      ...
      desc:
        "Orchestrated large-scale competitive programming events for 500+ participants and collaborated with the executive board to curate and stress-test problem sets, ensuring 100% error-free contests."
    },
    {
      ...
      desc:
        "Spearheaded 'Code Crusade' and co-organized 'Game of Codes', driving 700+ registrations and 500+ active logins while authoring high-quality algorithmic problems."
    }
  ];
  ...
  return (
    <div className="bg-slate-950 min-h-screen text-slate-200 font-sans selection:bg-cyan-500/30">
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-white mb-10">Achievements</h2>
        <ul className="space-y-4 text-slate-400">
          <li>🏆 CodeChef Max Rating: <b>1639</b> (35+ contests)</li>
          <li>🥇 LeetCode Max Rating: <b>1814</b> (26+ contests)</li>
          <li>⚔️ Codeforces: <b>Pupil</b> (Max 1249)</li>
          <li>🧠 Problem Setter for multiple university-level contests</li>
        </ul>
      </section>
